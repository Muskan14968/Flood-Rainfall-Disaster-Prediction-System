...
def alerting():
    data1=pd.read_csv('sourceCode/data/forecast/forecasted_level_of_rivers.csv')
    res=[]
...
def water_level_predictior():
    ...
    def dataCreator(filename):
        #filename='Cauvery'
        data1=pd.read_csv('sourceCode/data/forecast/'+filename+'_discharge_forecast.csv')
        data2=pd.read_csv('sourceCode/data/forecast/'+filename+'_flood_runoff_forecast.csv')
        data3=pd.read_csv('sourceCode/data/forecast/'+filename+'_daily_runoff_forecast.csv')
        data4=pd.read_csv('sourceCode/data/forecast/'+filename+'_weekly_runoff_forecast.csv')
    ...
    y_pred.to_csv('sourceCode/data/forecast/forecasted_level_of_rivers.csv',index=False)
    return
